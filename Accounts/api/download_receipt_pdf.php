...
// Extract current paid amount and payment mode
$receiptPaidCurr = 0;
...
$paidThisInstallment = $receiptPaidCurr;
...
$logo = getBase64(__DIR__ . '/../assets/TRISHAKI LOGO TRANSPERANT BG.png');
$sign = getBase64(__DIR__ . '/../assets/ningaraj_sign_blue.png');
$qrCode = getBase64(__DIR__ . '/../assets/image.png');

if (!class_exists('Dompdf\Dompdf')) {
    // If Dompdf is not installed, fallback to inline HTML print
    $_GET['receiptNo'] = $receiptNo;
